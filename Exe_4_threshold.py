def main():
    ...
    img = cv2.imread('/Users/apple1/Desktop/Test_images/Lenna.png')
    gray = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
    cv2.imwrite('/Users//apple1/Desktop/Test_images/Lenna.png',gray)
    
    ret,dst=cv2.threshold(gray,127, 255, 2 );
    cv2.imwrite('/Users/apple1/Desktop/Test_images/Lenna_threshold.png',dst)
    #binary threshold
    ...
    cv2.imwrite('/Users/apple1/Desktop/Test_images/Lenna_band.png',band_thresholded_image)
    ...
    cv2.imwrite('/Users/apple1/Desktop/Test_images/Lenna_semi.png',semi_thresholded_image)
    
    #adaptive
    adaptive_thresh=cv2.adaptiveThreshold(gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 101, 10 )
    cv2.imwrite('/Users/apple1/Desktop/Test_images/Lenna_adptive.png',adaptive_thresh)
